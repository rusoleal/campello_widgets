...
namespace systems::leal::campello_widgets
{
    ...
    private:
        ...
        VelocityTracker velocity_tracker_x_, velocity_tracker_y_;
        ...
        // wheel scrolling never goes through the drag path above, so these
        // track each axis's own recent velocity to hand off to onTick()'s
